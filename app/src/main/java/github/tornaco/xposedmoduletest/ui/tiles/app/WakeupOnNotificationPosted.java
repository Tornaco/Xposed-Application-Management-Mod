    ...
    public WakeupOnNotificationPosted(final Context context) {
        ...
        this.tileView = new SwitchTileView(context) {
            ...
            protected void onBindActionView(RelativeLayout container) {
                ...
                setChecked(XAshmanManager.get().isServiceAvailable() && XAshmanManager.get().isWakeupOnNotificationEnabled());
            }
            ...
            protected void onCheckChanged(boolean checked) {
                ...
                if (XAshmanManager.get().isServiceAvailable()) {
                    XAshmanManager.get().setWakeupOnNotificationEnabled(checked);
                }
            }
        };
    }
