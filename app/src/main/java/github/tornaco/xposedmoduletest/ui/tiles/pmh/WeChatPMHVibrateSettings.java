        ...
        this.tileView = new SwitchTileView(context) {
            ...
            protected void onBindActionView(RelativeLayout container) {
                ...
                setChecked(XAshmanManager.get().isServiceAvailable()
                        && XAshmanManager.get().isPushMessageHandlerNotificationVibrateEnabled("wechat"));
            }
            ...
            protected void onCheckChanged(boolean checked) {
                ...
                if (XAshmanManager.get().isServiceAvailable()) {
                    XAshmanManager.get().setPushMessageHandlerNotificationVibrateEnabled("wechat", checked);
                }
            }
        };
    }
