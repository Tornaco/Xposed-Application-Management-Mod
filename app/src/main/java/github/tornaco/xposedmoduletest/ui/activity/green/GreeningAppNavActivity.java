...
public class GreeningAppNavActivity extends WithRecyclerView {
    ...
    protected void initView() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GreeningAppNavActivity.this, GreeningAppPickerActivity.class));
            }
        });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                switchBar.setChecked(XAshmanManager.get().isServiceAvailable()
                        && XAshmanManager.get().isGreeningEnabled());
                switchBar.addOnSwitchChangeListener(new SwitchBar.OnSwitchChangeListener() {
                    @Override
                    public void onSwitchChanged(SwitchCompat switchView, boolean isChecked) {
                        if (XAshmanManager.get().isServiceAvailable())
                            XAshmanManager.get().setGreeningEnabled(isChecked);
    ...
    protected List<AutoStartPackage> performLoading() {
        return GreeningPackageLoader.Impl.create(this).loadInstalled(true);
    }
