package github.tornaco.xposedmoduletest.ui.tiles.comp;
...
import github.tornaco.xposedmoduletest.ui.activity.comp.GeneralCompSettings;
    ...
    public General(final Context context) {
        ...
        this.tileView = new QuickTileView(context, this) {
            ...
            public void onClick(View v) {
                super.onClick(v);
                context.startActivity(new Intent(context, GeneralCompSettings.class));
            }
        };
    }
}
