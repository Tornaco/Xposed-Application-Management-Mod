...
public class MaterialSearchView<T> extends FrameLayout implements View.OnClickListener, onSearchActionsListener<T> {
    ...
    private onSimpleSearchActionsListener<T> searchListener;
    private SearchViewResults.SearchPerformer<T> searchPerformer;
    ...
    public void setSearchPerformer(SearchViewResults.SearchPerformer<T> searchPerformer) {
        this.searchPerformer = searchPerformer;
        if (searchViewResults != null) searchViewResults.setSearchPerformer(searchPerformer);
    }
    ...
    public void setSearchResultsListener(onSimpleSearchActionsListener<T> listener) {
    ...
    public void onQuery(String query) {
        ...
        if (searchViewResults != null) {
            ...
            searchViewResults.setSearchPerformer(searchPerformer);
        }
    }
