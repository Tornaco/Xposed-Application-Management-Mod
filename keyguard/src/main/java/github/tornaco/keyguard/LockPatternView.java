...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        mRegularColor = context.getResources().getColor(R.color.lock_pattern_view_regular_color);
        mErrorColor = context.getResources().getColor(R.color.lock_pattern_view_error_color);
        mSuccessColor = context.getResources().getColor(R.color.lock_pattern_view_success_color);
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        private CharSequence getTextForVirtualView(int virtualViewId) {
            ...
            return shouldSpeakPassword() ? res.getString(
                    R.string.lockscreen_access_pattern_cell_added_verbose, String.valueOf(virtualViewId))
