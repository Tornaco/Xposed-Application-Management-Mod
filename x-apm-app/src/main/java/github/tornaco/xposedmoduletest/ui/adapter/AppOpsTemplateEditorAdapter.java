...
public class AppOpsTemplateEditorAdapter extends RecyclerView.Adapter<AppOpsTemplateEditorAdapter.PermissionHolder> {
    ...
    public AppOpsTemplateEditorAdapter(Context context) {
    ...
    @Override
    public AppOpsTemplateEditorAdapter.PermissionHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AppOpsTemplateEditorAdapter.PermissionHolder holder, int position) {
        ...
        holder.getCompSwitch().setOnClickListener(v -> {
    ...
    static final class PermissionHolder extends RecyclerView.ViewHolder {
        ...
        PermissionHolder(View itemView) {
            ...
            itemView.setOnClickListener(v -> compSwitch.performClick());
        }
    }
}
