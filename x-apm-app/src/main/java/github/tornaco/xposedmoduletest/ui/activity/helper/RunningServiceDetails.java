...
public class RunningServiceDetails extends PreferenceFragment {
    ...
    class ActiveDetail implements View.OnClickListener {
        ...
        void stopActiveService(boolean confirmed) {
            ...
            XAPMManager.get().stopService(new Intent().setComponent(si.mRunningService.service));
            if (mMergedItem == null) {
    ...
    boolean findMergedItem() {
        if (RunningServicesLoadingCache.getInstance().getMergedItem() != null) {
            mMergedItem = RunningServicesLoadingCache.getInstance().getMergedItem();
            return true;
        }
...
//                &&pi.mUserId != UserHandle.myUserId()
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUserId = getArguments().getInt(KEY_USER_ID, UserHandle.USER_CURRENT);
