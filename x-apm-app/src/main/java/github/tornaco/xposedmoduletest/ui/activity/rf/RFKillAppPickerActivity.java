...
public class RFKillAppPickerActivity extends CommonPackageInfoListPickerActivity implements AdapterView.OnItemSelectedListener {

    public static void start(Context context) {
        Intent starter = new Intent(context, RFKillAppPickerActivity.class);
    ...
    protected List<CommonPackageInfo> performLoading() {
        return RFKillPackageLoader.Impl.create(this).loadInstalled(mFilterOption, false);
    }
}
