...
public class LazyRuleNavActivity extends CommonPackageInfoListActivity
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, LazyRuleNavActivity.class);
    ...
    protected int getSummaryRes() {
        return R.string.summary_lazy_rules;
    }
    ...
    protected List<CommonPackageInfo> performLoading() {
        return LazyRuleLoader.Impl.create(this).loadInstalled();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.lazy_rule, menu);
