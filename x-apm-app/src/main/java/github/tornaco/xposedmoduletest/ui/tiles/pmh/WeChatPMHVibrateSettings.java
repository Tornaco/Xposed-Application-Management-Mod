        ...
        this.tileView = new SwitchTileView(context) {
            ...
            protected void onBindActionView(RelativeLayout container) {
                ...
                setChecked(XAshmanManager.get().isServiceAvailable()
                        && XAshmanManager.get().isPushMessageHandlerNotificationVibrateEnabled(WeChatPushNotificationHandler.WECHAT_PKG_NAME));
            }
            ...
            protected void onCheckChanged(boolean checked) {
                ...
                if (XAshmanManager.get().isServiceAvailable()) {
                    XAshmanManager.get().setPushMessageHandlerNotificationVibrateEnabled(WeChatPushNotificationHandler.WECHAT_PKG_NAME, checked);
                }
            }
        };
    }
