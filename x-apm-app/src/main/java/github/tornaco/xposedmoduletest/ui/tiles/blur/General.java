package github.tornaco.xposedmoduletest.ui.tiles.blur;
...
import github.tornaco.xposedmoduletest.ui.activity.blur.GeneralBlurSettings;
    ...
    public General(final Context context) {
        ...
        this.tileView = new QuickTileView(context, this) {
            ...
            public void onClick(View v) {
                super.onClick(v);
                context.startActivity(new Intent(context, GeneralBlurSettings.class));
            }
        };
    }
}
