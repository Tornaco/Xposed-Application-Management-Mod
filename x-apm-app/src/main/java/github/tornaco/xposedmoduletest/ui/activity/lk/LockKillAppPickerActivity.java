...
public class LockKillAppPickerActivity extends CommonPackageInfoListPickerActivity implements AdapterView.OnItemSelectedListener {

    public static void start(Context context) {
        Intent starter = new Intent(context, LockKillAppPickerActivity.class);
    ...
    protected List<CommonPackageInfo> performLoading() {
        return LockKillPackageLoader.Impl.create(this).loadInstalled(mFilterOption, false);
    }
}
