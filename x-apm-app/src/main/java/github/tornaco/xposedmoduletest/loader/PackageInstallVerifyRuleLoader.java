...
public interface PackageInstallVerifyRuleLoader {

    @NonNull
    List<CommonPackageInfo> loadInstalled();

    class Impl implements PackageInstallVerifyRuleLoader {

        public static PackageInstallVerifyRuleLoader create(Context context) {
        ...
        public List<CommonPackageInfo> loadInstalled() {
            ...
            String[] rules = xAshmanManager.getPackageInstallerVerifyRules();
